...
<!DOCTYPE html>
	...
	<head>
		...
		<style>
			...
			.video-container {margin: -1px auto 0;width: 480px;height: 270px;background-color: #000;overflow: hidden;position: relative;}
		</style>
		...
		<header id="head">
			<div class="container"> 
				<div class="page-header">
					<h1 class="text-center"><strong>ДЕМОНСТРАЦИЯ ВОЗМОЖНОСТЕЙ</strong><small><br>Конфигуратор v.2.4 Lite</small></h1>
	...
	<?  lands::footer($body2_index64, $polit, $mask_phone); // Дополнительная часть скриптов, ставим перед закрывающимся /body ?>
	</body>
</html>
